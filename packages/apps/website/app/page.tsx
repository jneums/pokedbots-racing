          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-1 text-sm">
                        <span>SPD: 38</span>
                        <span className="text-primary font-semibold">PWR: 43</span>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Best value Blackhole! Balanced 43 power and acceleration. Super-rare at an incredible price.
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Acceleration specialist! 47 acceleration benefits from Blackhole's +16 bonus. Great for technical courses.
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Speed and stability focused Blackhole. Premium super-rare with balanced performance stats.
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="font-semibold">Rating:</span>
                        <span className="text-foreground font-bold">47/100 🏆</span>
                      </div>
                      <div className="grid grid-cols-2 gap-1 text-sm">
                        <span>SPD: 42</span>
                        <span>PWR: 48</span>
                        <span className="text-primary font-semibold">ACC: 49</span>
                        <span className="text-primary font-semibold">STB: 50</span>
                      </div>
                    </div>
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Highest-rated Dead bot! Maximum stability (50) + strong acceleration (49). Ultra-rare super-rare!
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Peak stability at 50! Dead faction undead resilience perfect for rough terrain endurance.
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
              ...
              <Link href="/guides/wildbot-shopping-guide" className="block">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Speed-focused Dead bot with 44 speed. Affordable entry into the super-rare Dead faction!
                  </p>
                  <Button className="w-full" variant="outline">View Guide</Button>
                </CardContent>
              </Card>
