...
export const SMR_TIERS: SMRTier[] = [
  {
    ...
    features: [
      '+250 MW capacity',
      '~60 GWh lifetime (~1 month)',
      'Salvaged core design',
  ...
  },
  {
    ...
    features: [
      '+500 MW capacity',
      '~120 GWh lifetime (~1 month)',
      'Refurbished industrial core',
  ...
  },
  {
    ...
    features: [
      '+880 MW capacity',
      '~210 GWh lifetime (~1 month)',
      'Hardened reactor vessel',
