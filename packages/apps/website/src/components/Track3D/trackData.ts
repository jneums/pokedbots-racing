...
export const TRACK_TEMPLATES: Record<number, TrackTemplate> = {
  ...
  14: {
    ...
    segments: [
      ...
      { length: 1800, angle: -15, terrain: 'WastelandSand', difficulty: 1.08 },
      { length: 2000, angle: -10, terrain: 'WastelandSand', difficulty: 1.12 },
      ...
      { length: 1000, angle: -20, terrain: 'WastelandSand', difficulty: 1.05 },
    ],
  },
  15: {
    trackId: 15,
    ...
    segments: [
      ...
      { length: 1900, angle: -10, terrain: 'WastelandSand', difficulty: 1.08 },
