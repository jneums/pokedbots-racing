...
module {
  ...
  public func config() : McpTypes.Tool = {
    ...
    description = ?"Register a PokedBot for racing (0.1 ICP one-time fee). Required before entering races. Establishes your control over the bot — only one principal can control a bot at a time. Re-register after purchasing a bot from another player. Requires ICRC-2 approval. Use help_get_compendium for race class brackets and faction bonuses.";
    payment = null;
