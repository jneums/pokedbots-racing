          ...
          switch (garage.startScavengingMission(tokenIndex, zone, now, durationMinutes)) {
            ...
            case (#ok(_)) {
              ...
              let response = Json.obj([
                ...
                ("world_buff_chance", Json.str("3.75%-6.0% per check (scales with Acceleration stat)")),
