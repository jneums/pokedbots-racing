...
export interface McpServer {
  ...
  'admin_get_resonance' : ActorMethod<[bigint], Result_16>,
  'admin_get_stat_breakdown' : ActorMethod<[bigint], Result_15>,
  ...
  'clear_race_create_diagnostics' : ActorMethod<[], Result_14>,
  ...
  'force_schedule_race_create' : ActorMethod<[], Result_13>,
  ...
  'set_ext_canister' : ActorMethod<[Principal], Result_10>,
  'set_icp_ledger' : ActorMethod<[Principal], Result_10>,
  'set_owner' : ActorMethod<[Principal], Result_12>,
  ...
  'unregister_from_event' : ActorMethod<[bigint, bigint], Result_11>,
  ...
  'upload_nft_stats_batch' : ActorMethod<
    ...
    Result_10
  >,
  'upload_trait_schema' : ActorMethod<[TraitSchema], Result_10>,
  ...
  >,
  'web_get_bot_details' : ActorMethod<[bigint], Result_8>,
  ...
  'web_jolt_bot' : ActorMethod<[bigint, bigint], Result_7>,
  ...
  'web_list_my_registered_bots' : ActorMethod<
    ...
    >
  >,
  'web_purchase_smr' : ActorMethod<[string], Result_6>,
  'web_rebuild_battery' : ActorMethod<[bigint, boolean], Result_1>,
  'web_recharge_bot' : ActorMethod<[bigint], Result_1>,
  'web_repair_battery' : ActorMethod<[bigint], Result_5>,
  'web_repair_bot' : ActorMethod<[bigint], Result_1>,
  'web_respec_bot' : ActorMethod<[bigint, Array<string>], Result_4>,
  'web_salvage_battery' : ActorMethod<[bigint], Result_3>,
  ...
  'web_start_scavenging' : ActorMethod<
    ...
    Result_1
  >,
  'web_toggle_battery' : ActorMethod<[bigint], Result_2>,
...
export type Result_12 = { 'ok' : null } |
  { 'err' : TreasuryError };
export type Result_13 = { 'ok' : { 'id' : bigint, 'time' : bigint } } |
  { 'err' : string };
